...
<head>
    ...
    <style>
        ...
        .wrapper{width: 100%;height: 450px;position: absolute;top: 50%;left: 50%;transform: translate(-40%,-50%)}
        #test1{border-radius: 5%;overflow: hidden}
        .admin-login-background {width:360px;height:300px;position:absolute;margin-left:180px;}
...
<div class="layui-container">
    <div class="layui-row wrapper">
        <div class="layui-col-md5">
            <div class="layui-carousel" id="test1">
                <div carousel-item>
                    <div><img src="static/images/01.jpg" /></div>
                    <div><img src="static/images/02.jpg" /></div>
                    <div><img src="static/images/03.jpg" /></div>
                </div>
            </div>
        </div>
        <div class="layui-col-md5">
